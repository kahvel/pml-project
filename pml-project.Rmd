...
```
but the result is already saved in file `linear_svm.rds` so we can load this object
```{r}
...
Yea `r round(confusionMatrix(validation$classe, predict(model, validation))$overall[1]*100)`%! Good enough for me. 